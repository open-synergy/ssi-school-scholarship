...
odoo.define(
    "ssi_school_scholarship_deduction_operating_unit.school_scholarship_deduction_recognition_tour",
    function (require) {
        "use strict";
        ...
        // inherited from the parent Deduction, not user-filled).
        // Navigation (open menu -> New -> select Deduction) is taken
        // from the base IK
        // ssi_school_scholarship_deduction/docs/school_scholarship_deduction_recognition/
        ...
        // Deduction auto-fills the Operating Unit field, visible here as
        // the m2o "open record" external button appearing -- not the
        // field's exact value, which is odoo-development-unit-test's
        // job. The tour stops there; it does not fill Journal/Amount or
        // save.
        tour.register(
            ...
            [
                ...
                // Scholarship Deduction Recognitions menu.
                ...
                // ── Base Flow 3 (partial) — Select the Deduction.
                ...
                // derivation.
                {
                    ...
                    run: "text TOUR-DEDUCTION-OU-RECOG-001",
                },
                {
                    content: "Pick the Deduction from the dropdown",
                    trigger:
                        ".ui-autocomplete .ui-menu-item a:contains(TOUR-DEDUCTION-OU-RECOG-001)",
                    in_modal: false,
                },

                // ── Delta assertion — the Operating Unit field is
                // auto-filled by the onchange this module registers on
                // deduction_id. The "open record" external button on a
