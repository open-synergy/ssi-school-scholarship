...
- **Operating Unit**: Select the operating unit(s) this Funding Source belongs to. Leave
...
- The Funding Source list is filtered by a record rule: a user only sees records that
