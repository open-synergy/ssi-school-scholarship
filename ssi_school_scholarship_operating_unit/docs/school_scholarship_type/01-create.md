...
- **Operating Unit**: Select the operating unit(s) this Scholarship Type belongs to.
  Leave empty to make the record visible to every operating unit. Only visible to users
  in the _Multiple Operating Unit_ group.

## Modified — Record Visibility

- The Scholarship Type list is filtered by a record rule: a user only sees records that
