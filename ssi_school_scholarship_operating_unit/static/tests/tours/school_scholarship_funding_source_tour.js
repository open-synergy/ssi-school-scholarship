...
odoo.define(
    "ssi_school_scholarship_operating_unit.school_scholarship_funding_source_tour",
    function (require) {
        "use strict";
        ...
        tour.register(
            "ssi_school_scholarship_operating_unit_school_scholarship_funding_source_create",
            {
                test: true,
                url: "/web",
            },
