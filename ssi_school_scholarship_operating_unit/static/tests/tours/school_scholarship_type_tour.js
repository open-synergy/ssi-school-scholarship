...
odoo.define(
    "ssi_school_scholarship_operating_unit.school_scholarship_type_tour",
    function (require) {
        "use strict";

        var tour = require("web_tour.tour");

        // IK: docs/school_scholarship_type/01-create.md (E1 delta --
        // Additional Fields). Navigation (open menu -> New) is taken from
        // the base IK ssi_school_scholarship/docs/school_scholarship_type/
        ...
        tour.register(
            "ssi_school_scholarship_operating_unit_school_scholarship_type_create",
            {
                test: true,
                url: "/web",
            },
