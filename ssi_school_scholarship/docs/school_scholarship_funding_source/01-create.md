...
- **Data:** A `school` and a `school_academic_year` exist, if this funding source is to be
  earmarked for a specific school or academic year.
...
3. Fill in the required fields:
   ...
   - **Code** _(required)_: Enter a unique code identifying this funding source, or enter
     **/** to assign it later using **Generate Code**.
   - **Analytic Account** _(required)_: Select the `account.analytic.account` this
     funding source is bound to. An analytic account already bound to another Scholarship
     Funding Source cannot be selected again.
