...
3. Fill in the required fields:
   ...
   - **Scholarship Type** _(required)_: Select the `school_scholarship_type` this program
     follows. Selecting it fills the Deduction Journal, Discount Account, Is Employee
     Benefit, Employee Benefit Account, Disbursement Journal, Expense Account, Payable
     Account, Deferred Discount Account, Deferred Expense Account, and Recognition
     Journal fields on the Deduction, Disbursement, and Deferred Recognition tabs from
...
5. Review the accounting fields defaulted from the Scholarship Type on the **Deduction**,
   **Disbursement**, and **Deferred Recognition** tabs, and override any of them if this
   program needs a different account or journal than its type. On the **Deduction** tab,
   **Allow Asymmetric Recognition** may also be checked as an explicit opt-in for a
   foundation that intentionally defers the deduction/expense recognition of an award
   without deferring the related revenue recognition.
